...
Hash-Chain mit prev_hash fuer Tamper-Evidence.
"""
import hmac
import hashlib
import json
...
class AuditLogger:
    """Append-only Audit-Log mit HMAC-SHA256 Hash-Chain."""
    ...
    def __init__(self, state_dir: Path, secret_env: str = "DF_AUDIT_SECRET"):
        ...
        # Default-secret nur fuer Sandbox; Real-Mode setzt env-var
    ...
    def append_event(self, event: dict) -> dict:
        """Append event mit HMAC-Hash-Chain."""
    ...
    def verify_chain(self) -> tuple[bool, Optional[str]]:
        """Verifiziert Hash-Chain-Integritaet."""
        if not self.log_path.exists():
            return True, None
        prev = "0" * 64
